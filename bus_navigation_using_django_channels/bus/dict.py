...
DB = {'lines': [
    {'name': 'Bagheri',
     ...
     'buses': [
        {'speed': "", 'x_pos': 35.747381,   'y_pos': 51.5280835,    'next': "Daneshvar",    'prev': "Daneshvar",    'is_on_station': "False",   'token': "qwerty"},
        {'speed': "", 'x_pos': 35.745979,   'y_pos': 51.526678,     'next': "Daneshvar",    'prev': "Borzuyi",      'is_on_station': "True",    'token': "qwerty"},
        {'speed': "", 'x_pos': 35.7367045,  'y_pos': 51.5200000,    'next': "Taghato",      'prev': "Daneshvar",    'is_on_station': "False",   'token': "qwerty"},
        {'speed': "", 'x_pos': 35.736687,   'y_pos': 51.517006,     'next': "Seraj",        'prev': "Khodabande",   'is_on_station': "False",   'token': "qwerty"},
        {'speed': "", 'x_pos': 35.737114,   'y_pos': 51.513954,     'next': "Kababi",       'prev': "Taghato",      'is_on_station': "True",    'token': "qwerty"},
        {'speed': "", 'x_pos': 35.737445,   'y_pos': 51.511663,     'next': "41",           'prev': "Seraj",        'is_on_station': "False",   'token': "qwerty"},
        {'speed': "", 'x_pos': 35.747381,   'y_pos': 51.5280835,    'next': "Meydan57",     'prev': "Daneshvar",    'is_on_station': "False",   'token': "qwerty"},
        {'speed': "", 'x_pos': 35.739709,   'y_pos': 51.493870,     'next': "Hengam",       'prev': "41",           'is_on_station': "True",    'token': "qwerty"},
        {'speed': "", 'x_pos': 35.739961,   'y_pos': 51.492046,     'next': "Meydan57",     'prev': "Meydan57",     'is_on_station': "True",    'token': "qwerty"}, ]},
    ...
    {'name': 'Resalat',
     ...
     'buses': [
         {'speed': "", 'x_pos': 35.730756, 'y_pos': 51.533331, 'next': "121st",     'prev': "121st",    'is_on_station': "False",   'token': "qwerty"},
         {'speed': "", 'x_pos': 35.731183, 'y_pos': 51.530091, 'next': "Hojr",      'prev': "Resalat",  'is_on_station': "True",    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.732022, 'y_pos': 51.523732, 'next': "Gas",       'prev': "121st",    'is_on_station': "False",   'token': "qwerty"},
         {'speed': "", 'x_pos': 35.732141, 'y_pos': 51.522752, 'next': "Bagheri",   'prev': "Hojr",     'is_on_station': "True",    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.733211, 'y_pos': 51.514920, 'next': "Yas",       'prev': "Gas",      'is_on_station': "False",   'token': "qwerty"},
         {'speed': "", 'x_pos': 35.733516, 'y_pos': 51.512161, 'next': "shaparak",  'prev': "Seraj",    'is_on_station': "True",    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.734527, 'y_pos': 51.504759, 'next': "mehr",      'prev': "Yas",      'is_on_station': "False",   'token': "qwerty"},
         {'speed': "", 'x_pos': 35.734805, 'y_pos': 51.502559, 'next': "salehi",    'prev': "41",       'is_on_station': "True",    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.735275, 'y_pos': 51.498707, 'next': "sarsabz",   'prev': "mehr",     'is_on_station': "True",    'token': "qwerty"}, ]},
    ...
    {'name': 'Hengam',
     ...
     'buses': [
         {'speed': "", 'x_pos': 35.755564, 'y_pos': 51.511877, 'next': "6th",       'prev': "6th",          'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.753492, 'y_pos': 51.509420, 'next': "Azadegan",  'prev': "Cheraghi",     'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.752125, 'y_pos': 51.507553, 'next': "Hasanpoor", 'prev': "6th",          'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.750392, 'y_pos': 51.505225, 'next': "Varbaz",    'prev': "Azadegan",     'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.748694, 'y_pos': 51.502843, 'next': "shahr",     'prev': "Hasanpoor",    'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.745185, 'y_pos': 51.498036, 'next': "mehr",      'prev': "Varbaz",       'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.743339, 'y_pos': 51.495869, 'next': "Bahar",     'prev': "shahr",        'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.741617, 'y_pos': 51.493867, 'next': "mehr",      'prev': "mehr",         'is_on_station': 'True',    'token': "qwerty"}, ]},
    ...
    {'name': 'Emam-Ali HW',
     'stations': [
        ...
        {'name': "boostan",     'x_pos': 35.747129, 'y_pos': 51.483391, 'next': "shahr",        'prev': "Hasanpoor",    'is_final_station': 'False'},
        {'name': "taleghani",   'x_pos': 35.744475, 'y_pos': 51.483115, 'next': "mehr",         'prev': "Varbaz",       'is_final_station': 'False'},
     ...
     'buses': [
         {'speed': "", 'x_pos': 35.758475, 'y_pos': 51.484625, 'next': "6th",       'prev': "6th",          'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.755941, 'y_pos': 51.485097, 'next': "Azadegan",  'prev': "Cheraghi",     'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.752719, 'y_pos': 51.485312, 'next': "Hasanpoor", 'prev': "6th",          'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.749811, 'y_pos': 51.484153, 'next': "Varbaz",    'prev': "Azadegan",     'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.747129, 'y_pos': 51.483391, 'next': "shahr",     'prev': "Hasanpoor",    'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.744475, 'y_pos': 51.483115, 'next': "mehr",      'prev': "Varbaz",       'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.742150, 'y_pos': 51.483662, 'next': "Bahar",     'prev': "shahr",        'is_on_station': 'True',    'token': "qwerty"},
         {'speed': "", 'x_pos': 35.739024, 'y_pos': 51.483565, 'next': "mehr",      'prev': "mehr",         'is_on_station': 'True',    'token': "qwerty"}, ]}
]}
